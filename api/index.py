...
def health_check():
    ...
    return jsonify({
        ...
        "timestamp": os.environ.get('VERCEL_DEPLOYMENT_CREATED', '알 수 없음')
    })
...
def start_game():
    ...
    try:
        ...
        if not selected_item_id:
            ...
            target_item = random.choice(GAMES)
            ...
            try:
                ...
                target_item = next((item for item in GAMES if item['id'] == selected_item_id), None)
            except:
                target_item = None
